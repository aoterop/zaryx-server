...
{
    public class MonstruoEntidadCombate : IEntidadCombate
    {
        #region Miembros
        ...
        // Propiedades propias de los monstruos.
        ...
        public MonstruoEntidadCombate(int hp, int mp, short mapa, short x, short y, short origenX, short origenY, byte nivel, long exp)
        {
            Hp = hp;
            Mp = mp;
            MaxHp = hp;
